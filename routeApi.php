...
$router->addRoute('comentarios/puntaje/:ID/:order', 'GET', 'apiController', 'obtenerComentariosByPuntaje');
$router->addRoute('comentarios/puntos/:ID/:puntos', 'GET', 'apiController', 'obtenerComentariosByPuntos');
